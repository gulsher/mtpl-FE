            ...
            <div>
                <div className="channelsinfo">
                    <h5 className="main__head">
                        <b>PACKS</b>
                        <button className="btn blueborder-btn" data-toggle="modal" data-target="#addPackModal">Add Pack
                        </button>
                    </h5>
                ...
                <div className="modal fade" id="addPackModal" tabIndex="-1" role="dialog"
                    aria-labelledby="addPackLabel" aria-hidden="true">
                    <div className="modal-dialog modal-dialog-centered" role="document">
                        <div className="modal-content border-0 custom__modal">
                            <div className="modal-header">
                                <h5 className="modal-title" id="addPackLabel">Add Pack</h5>
                            ...
                            <div className="modal-body pm-30">
                                <div className="form-group mb-0">
                                    <input type="text" className="form-control blue-from" placeholder="Pack Name" onChange={this.inputHandler} value={this.state.inputPack} />
                    ...
                    {this.validator.message(
                      ...
                      "required"
                            ...
                            <div className="modal-footer">
                                <button type="button" className="btn blue__btn" onClick={this.addPack} >Add Package</button>
